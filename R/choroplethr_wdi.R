...
#' choroplethr_wdi(code="SP.POP.TOTL", year=2012, title="2012 Per Capita Income", scale=1)
#'
...
#' @export
#' @importFrom WDI WDI
choroplethr_wdi = function(code="SP.POP.TOTL", year=2012, title="", scale=7, zoom=NULL)
{
  if (is.null(title))
  {
  ...
  country_choropleth(data, title, "", scale, zoom)
}