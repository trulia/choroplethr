...
You can create a choropleth of US ZIP codes with the function `zip_choropleth`. Note that what is rendered are actually US Zip Code Tabulated Areas (ZCTAs) from the US Census Bureau.  See `?zip.map` in the package `choroplethrZip` for more details.

Here is a map of all zip codes in the state of New York:
