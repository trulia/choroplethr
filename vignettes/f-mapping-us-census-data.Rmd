...
3. `?zip_choropleth_acs`

## Census API Key

To use these functions you must get and install a Census API. It is free and you can get one [here](http://www.census.gov/developers/tos/key_request.html). Then type the following from R:
