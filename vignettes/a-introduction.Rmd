...
```{r}
    ...
    state_choropleth(df_pop_state, title="2012 US State Population Estimates", legend_name="Population")
```
...
1. It provides ready-made functions for creating choropleths with four different maps (US States, US Counties, US ZIPs and Countries of the world).
2. It provides API connections to interesting data sources for making choropleths.
3. It provides a framework for creating from arbitrary shapefiles.
